...
export function ReceiptIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function TempleIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CardIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CertificateIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function PhoneIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function UserCheckIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function PrayingHandsIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path d="M12 4v16" />
      <path d="M8 8c0-2.2 1.8-4 4-4s4 1.8 4 4v10c0 1.1-.9 2-2 2h-4c-1.1 0-2-.9-2-2V8z" />
      <path d="M5 11l3 3" />
      <path d="M19 11l-3 3" />
    </svg>
  );
...
export function HeartHandIcon({ className = 'h-4 w-4', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
